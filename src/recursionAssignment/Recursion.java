...
public class Recursion{
  ...
  //public static int count7(int n){
    ...
    //}else{
      ...
      //return 0 if the number divided by 10 doesn't have a remainder of 7 and add the number divided by 10
      //this will continue until n=0 and then the all the returns will be added together
   // }
//  }
